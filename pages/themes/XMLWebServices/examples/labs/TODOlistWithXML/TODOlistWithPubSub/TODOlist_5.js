...
var getXMLdata = {
	makeRequestNew: function(){
		var xhr = new XMLHttpRequest();
		xhr.addEventListener("load", this.processResponse);
		xhr.open("GET", "../data/todos.xml");
		xhr.send();
		// console.dir(xhr);
	},
	makeRequestOld: function(){
		var xhr = new XMLHttpRequest();
		...
		xhr.open("GET", "../data/todos.xml", true);
		xhr.send();
	},
	processResponse:function(){
		console.log(`processResponse()`);
		console.dir(this);
		// this.DOMParseXML(this.responseText);
	},
	parseXML: {
		DOMParser: function(){
